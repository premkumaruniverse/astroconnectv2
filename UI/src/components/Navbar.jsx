    ...
    <nav className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Navigation Links - Show based on role/auth */}
          {token && role === 'user' && (
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors text-sm font-medium">Marketplace</a>
              <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors text-sm font-medium">Live</a>
